...
function copy_txt() {
  ...
  alert(
    "Referral Link Copied, Share with Friends and Family to Earn 4% of their Investment"
  );
}
          ...
          '<div class="row col-sm-12 d-flex justify-content-end">\
            ...
            '</i></small>\
                        ...
                        <p class="mg_top_30">\
                           <img src="/img/profile/' +
            result.user_img +
            '" alt="..." class="avatar_chat rounded-circle">\
                        </p>\
                    </div>'
        );
        $("#chat_msg_container").animate(
          ...
          $("#chat_msg_container").append(
            '<div class="row col-sm-12">\
              ...
              '\
                                ...
                                <small class="font_10 p-0 float-right"><i>' +
              result[i].created_at +
              "</i></small>\
                              </div>\
                            </div>\
...
$(document).ready(function () {
  $("#card_select").change(function () {
    if (
      $("#card_select").val() == "idcard_op" ||
      $("#card_select").val() == "driver_op"
    ) {
      $("#pass_cont").hide();
      $("#card_cont").show();
  ...
  for (i = 1; i <= num; i++) {
    div_str =
      ...
      '<div class="col-sm-6 mt-3">\
                                <h6> Level ' +
      i +
      ' Referral Percentage </h6>\
                                <input type="number" step="any" name="' +
      i +
      '" value="" class="form-control" placeholder="" required>\
                            </div>';
  }
